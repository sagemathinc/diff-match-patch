...
describe("diff-match-patch-ts - core/DiffMatchPatch", () => {
  ...
  it("DIFF - Half Match", () => {
    ...
    // Single Match.
    expect(dmp["diff_halfMatch_"]("1234567890", "a345678z")).toStrictEqual([
      "12",
      "90",
      "a",
      "z",
    ...
    expect(dmp["diff_halfMatch_"]("a345678z", "1234567890")).toStrictEqual([
      "a",
      "z",
      "12",
      "90",
    ...
    expect(dmp["diff_halfMatch_"]("abc56789z", "1234567890")).toStrictEqual([
      "abc",
      "z",
      "1234",
      "0",
    ...
    expect(dmp["diff_halfMatch_"]("a23456xyz", "1234567890")).toStrictEqual([
      "a",
      "xyz",
      "1",
      "7890",
  ...
  it("DIFF - Cleanup Merge", () => {
    ...
    dmp.diff_cleanupMerge(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "ac"],
      [DiffOperation.DIFF_INSERT, "bd"],
      [DiffOperation.DIFF_EQUAL, "ef"],
    ]).toStrictEqual(diffs);

    // Prefix and suffix detection.
    diffs = [
      [DiffOperation.DIFF_DELETE, "a"],
      [DiffOperation.DIFF_INSERT, "abc"],
      [DiffOperation.DIFF_DELETE, "dc"],
    ];
    dmp.diff_cleanupMerge(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "a"],
      [DiffOperation.DIFF_DELETE, "d"],
      [DiffOperation.DIFF_INSERT, "b"],
      [DiffOperation.DIFF_EQUAL, "c"],
    ]).toStrictEqual(diffs);
    ...
    diffs = [
      ...
      [DiffOperation.DIFF_INSERT, "abc"],
      [DiffOperation.DIFF_DELETE, "dc"],
      [DiffOperation.DIFF_EQUAL, "y"],
    ];
    dmp.diff_cleanupMerge(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "xa"],
      [DiffOperation.DIFF_DELETE, "d"],
      [DiffOperation.DIFF_INSERT, "b"],
      [DiffOperation.DIFF_EQUAL, "cy"],
    ]).toStrictEqual(diffs);

    // Slide edit left.
    diffs = [
      [DiffOperation.DIFF_EQUAL, "a"],
      [DiffOperation.DIFF_INSERT, "ba"],
      [DiffOperation.DIFF_EQUAL, "c"],
    ];
    dmp.diff_cleanupMerge(diffs);
    expect([
      [DiffOperation.DIFF_INSERT, "ab"],
      [DiffOperation.DIFF_EQUAL, "ac"],
    ]).toStrictEqual(diffs);
    ...
    dmp.diff_cleanupMerge(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abc"],
      [DiffOperation.DIFF_EQUAL, "acx"],
    ]).toStrictEqual(diffs);

    // Slide edit right recursive.
    diffs = [
      [DiffOperation.DIFF_EQUAL, "x"],
      [DiffOperation.DIFF_DELETE, "ca"],
      [DiffOperation.DIFF_EQUAL, "c"],
      [DiffOperation.DIFF_DELETE, "b"],
      [DiffOperation.DIFF_EQUAL, "a"],
    ];
    dmp.diff_cleanupMerge(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "xca"],
      [DiffOperation.DIFF_DELETE, "cba"],
    ]).toStrictEqual(diffs);
  ...
  it("DIFF - Cleanup Semantic Lossless", () => {
    ...
    diffs = [
      [DiffOperation.DIFF_EQUAL, "AAA\r\nBBB"],
      [DiffOperation.DIFF_INSERT, " DDD\r\nBBB"],
      [DiffOperation.DIFF_EQUAL, " EEE"],
    ];
    dmp.diff_cleanupSemanticLossless(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "AAA\r\n"],
      [DiffOperation.DIFF_INSERT, "BBB DDD\r\n"],
      [DiffOperation.DIFF_EQUAL, "BBB EEE"],
    ]).toStrictEqual(diffs);

    // Word boundaries.
    diffs = [
      [DiffOperation.DIFF_EQUAL, "The c"],
      [DiffOperation.DIFF_INSERT, "ow and the c"],
      [DiffOperation.DIFF_EQUAL, "at."],
    ];
    dmp.diff_cleanupSemanticLossless(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "The "],
      [DiffOperation.DIFF_INSERT, "cow and the "],
      [DiffOperation.DIFF_EQUAL, "cat."],
    ]).toStrictEqual(diffs);
    ...
    diffs = [
      [DiffOperation.DIFF_EQUAL, "a"],
      [DiffOperation.DIFF_DELETE, "a"],
      [DiffOperation.DIFF_EQUAL, "ax"],
    ];
    dmp.diff_cleanupSemanticLossless(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "a"],
      [DiffOperation.DIFF_EQUAL, "aax"],
    ]).toStrictEqual(diffs);
    ...
    dmp.diff_cleanupSemanticLossless(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "xaa"],
      [DiffOperation.DIFF_DELETE, "a"],
    ]).toStrictEqual(diffs);

    // Sentence boundaries.
    diffs = [
      [DiffOperation.DIFF_EQUAL, "The xxx. The "],
      [DiffOperation.DIFF_INSERT, "zzz. The "],
      [DiffOperation.DIFF_EQUAL, "yyy."],
    ];
    dmp.diff_cleanupSemanticLossless(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "The xxx."],
      [DiffOperation.DIFF_INSERT, " The zzz."],
      [DiffOperation.DIFF_EQUAL, " The yyy."],
    ]).toStrictEqual(diffs);
  });
  ...
  it("DIFF - Cleanup Semantic", () => {
    ...
    diffs = [
      ...
      [DiffOperation.DIFF_INSERT, "cd"],
      [DiffOperation.DIFF_EQUAL, "12"],
      [DiffOperation.DIFF_DELETE, "e"],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "ab"],
    ...
    diffs = [
      [DiffOperation.DIFF_DELETE, "abc"],
      [DiffOperation.DIFF_INSERT, "ABC"],
      [DiffOperation.DIFF_EQUAL, "1234"],
      [DiffOperation.DIFF_DELETE, "wxyz"],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abc"],
    ...
    diffs = [
      [DiffOperation.DIFF_DELETE, "ab"],
      [DiffOperation.DIFF_EQUAL, "cd"],
      [DiffOperation.DIFF_DELETE, "e"],
      [DiffOperation.DIFF_EQUAL, "f"],
      [DiffOperation.DIFF_INSERT, "g"],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abcdef"],
      [DiffOperation.DIFF_INSERT, "cdfg"],
    ]).toStrictEqual(diffs);
    ...
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "AB_AB"],
      [DiffOperation.DIFF_INSERT, "1A2_1A2"],
    ]).toStrictEqual(diffs);

    // Word boundaries.
    diffs = [
      [DiffOperation.DIFF_EQUAL, "The c"],
      [DiffOperation.DIFF_DELETE, "ow and the c"],
      [DiffOperation.DIFF_EQUAL, "at."],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_EQUAL, "The "],
      [DiffOperation.DIFF_DELETE, "cow and the "],
      [DiffOperation.DIFF_EQUAL, "cat."],
    ]).toStrictEqual(diffs);

    // No overlap elimination.
    diffs = [
      [DiffOperation.DIFF_DELETE, "abcxx"],
      [DiffOperation.DIFF_INSERT, "xxdef"],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abcxx"],
    ...
    // Overlap elimination.
    diffs = [
      [DiffOperation.DIFF_DELETE, "abcxxx"],
      [DiffOperation.DIFF_INSERT, "xxxdef"],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abc"],
      [DiffOperation.DIFF_EQUAL, "xxx"],
      [DiffOperation.DIFF_INSERT, "def"],
    ]).toStrictEqual(diffs);

    // Reverse overlap elimination.
    diffs = [
      [DiffOperation.DIFF_DELETE, "xxxabc"],
      [DiffOperation.DIFF_INSERT, "defxxx"],
    ];
    dmp.diff_cleanupSemantic(diffs);
    expect([
      [DiffOperation.DIFF_INSERT, "def"],
  ...
  it("DIFF - Cleanup Efficiency", () => {
    ...
    diffs = [
      [DiffOperation.DIFF_DELETE, "ab"],
      [DiffOperation.DIFF_INSERT, "12"],
      [DiffOperation.DIFF_EQUAL, "xyz"],
      [DiffOperation.DIFF_DELETE, "cd"],
      [DiffOperation.DIFF_INSERT, "34"],
    ];
    dmp.diff_cleanupEfficiency(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abxyzcd"],
      [DiffOperation.DIFF_INSERT, "12xyz34"],
    ]).toStrictEqual(diffs);
    ...
    dmp.diff_cleanupEfficiency(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "xcd"],
      [DiffOperation.DIFF_INSERT, "12x34"],
    ]).toStrictEqual(diffs);
    ...
    expect([
      [DiffOperation.DIFF_DELETE, "abxyzcd"],
      [DiffOperation.DIFF_INSERT, "12xy34z56"],
    ]).toStrictEqual(diffs);
    ...
    dmp.diff_cleanupEfficiency(diffs);
    expect([
      [DiffOperation.DIFF_DELETE, "abwxyzcd"],
      [DiffOperation.DIFF_INSERT, "12wxyz34"],
    ]).toStrictEqual(diffs);
    dmp.diffEditCost = 4;
  });
  ...
  it("DIFF - Pretty Html", () => {
    ...
    const diffs: Diff[] = [
      [DiffOperation.DIFF_EQUAL, "a\n"],
      [DiffOperation.DIFF_DELETE, "<B>b</B>"],
      [DiffOperation.DIFF_INSERT, "c&d"],
    ];
    expect(
      '<span>a&para;<br></span><del style="background:#ffe6e6;">&lt;B&gt;b&lt;/B&gt;</del><ins style="background:#e6ffe6;">c&amp;d</ins>',
    ).toStrictEqual(dmp.diff_prettyHtml(diffs));
  });
  ...
  it("DIFF - Delta", () => {
    ...
    diffs = [
      [DiffOperation.DIFF_EQUAL, "\u0680 \x00 \t %"],
      [DiffOperation.DIFF_DELETE, "\u0681 \x01 \n ^"],
  ...
  it("DIFF - XIndex", () => {
    ...
    expect(
      dmp.diff_xIndex(
        [
          [DiffOperation.DIFF_DELETE, "a"],
          [DiffOperation.DIFF_INSERT, "1234"],
          [DiffOperation.DIFF_EQUAL, "xyz"],
        ],
        2,
      ),
    ...
    expect(
      dmp.diff_xIndex(
        [
          [DiffOperation.DIFF_EQUAL, "a"],
          [DiffOperation.DIFF_DELETE, "1234"],
          [DiffOperation.DIFF_EQUAL, "xyz"],
        ],
        3,
      ),
  ...
  it("DIFF - Bisect", () => {
    ...
    // Timeout.
    expect(dmp["diff_bisect_"](a, b, 0)).toStrictEqual([
      [DiffOperation.DIFF_DELETE, "cat"],
      [DiffOperation.DIFF_INSERT, "map"],
    ]);
  });
  ...
  it("DIFF - Main", () => {
    ...
    // Equality.
    expect([[DiffOperation.DIFF_EQUAL, "abc"]]).toStrictEqual(
      dmp.diff_main("abc", "abc", false),
    );

    // Simple insertion.
    expect([
      [DiffOperation.DIFF_EQUAL, "ab"],
      [DiffOperation.DIFF_INSERT, "123"],
      [DiffOperation.DIFF_EQUAL, "c"],
    ]).toStrictEqual(dmp.diff_main("abc", "ab123c", false));
    ...
    expect([
      ...
      [DiffOperation.DIFF_EQUAL, "bc"],
    ]).toStrictEqual(dmp.diff_main("a123bc", "abc", false));
    ...
    expect([
      [DiffOperation.DIFF_DELETE, "a"],
      [DiffOperation.DIFF_INSERT, "b"],
    ]).toStrictEqual(dmp.diff_main("a", "b", false));
  ...
  it("MATCH - Alphabet", () => {
    ...
    // Duplicates.
    expect({ a: 37, b: 18, c: 8 }).toStrictEqual(
  ...
  it("PATCH - Make", () => {
    ...
    // Character decoding.
    diffs = [
      [DiffOperation.DIFF_DELETE, "`1234567890-=[]\\;',./"],
      [DiffOperation.DIFF_INSERT, '~!@#$%^&*()_+{}|:"<>?'],
    ];
    expect(
      dmp.patch_fromText(
        "@@ -1,21 +1,21 @@\n-%601234567890-=%5B%5D%5C;',./\n+~!@#$%25%5E&*()_+%7B%7D%7C:%22%3C%3E?\n",
